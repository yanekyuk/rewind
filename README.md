...
| Platform | File |
|----------|------|
| Windows (64-bit) | [`rewind-x86_64-windows.zip`](https://github.com/yanekyuk/rewind/releases/download/v0.6.0/rewind-x86_64-windows.zip) |
| macOS (Apple Silicon) | [`rewind-aarch64-macos.tar.gz`](https://github.com/yanekyuk/rewind/releases/download/v0.6.0/rewind-aarch64-macos.tar.gz) |
| macOS (Intel) | [`rewind-x86_64-macos.tar.gz`](https://github.com/yanekyuk/rewind/releases/download/v0.6.0/rewind-x86_64-macos.tar.gz) |
| Linux (64-bit) | [`rewind-x86_64-linux.tar.gz`](https://github.com/yanekyuk/rewind/releases/download/v0.6.0/rewind-x86_64-linux.tar.gz) |
